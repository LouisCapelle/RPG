...
int create_highlights(game_t *game)
{
    ...
    if (!game->pausemenu->main_texture_highlight)
        return 84;
    return 0;
}
...
int display_highlight_start_pause(pausemenu_t *pausemenu,
sfVector2i pos, startmenu_t *startmenu)
{
    if (!pausemenu || !startmenu)
        return 84;
...
int display_highlight_quit_pause(pausemenu_t *pausemenu,
sfVector2i pos, startmenu_t *startmenu)
{
...
int display_highlight_main_pause(pausemenu_t *pausemenu,
sfVector2i pos, startmenu_t *startmenu)
{
    if (!pausemenu || !startmenu)
        return 84;
